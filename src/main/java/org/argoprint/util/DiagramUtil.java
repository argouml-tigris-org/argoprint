...
public class DiagramUtil {
    ...
    /**
     * This method converts a diagram name (which may include spaces) into a name
     * that may be used in a URL.
     * @param diagramName The name of the diagram.
     * @param ext       The file extension for the image.
     * @return  
     */
    public static String createDiagramFileName(String diagramName, String ext){
